...
# non-stemmed
choice2 <- sums2 %>% select(c(ArtDate, russian, URL))
choice2 <- unique(choice2)
#view(choice2)

# stemmed
choice2d <- sums2d %>% select(c(ArtDate, conflict, URL))
...
choice2d %>%
  ...
  ggsave("all-blm/conflict.png", width = 10)
```
